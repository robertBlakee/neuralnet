...
async function ifeModel_loadWeb() {
  ...
  const URL = 'https://tfhub.dev/google/tfjs-model/imagenet/mobilenet_v2_100_224/feature_vector/3/default/1';
...
function cModel_create(){
	...
	cModel.add(tf.layers.dense({inputShape: [1280], units: 128, activation: 'relu'}));	//mobileNet v1 and v3: 1024, v2: 1280
